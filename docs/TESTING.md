...
The packet gate has a 1,800-second limit per command, justified by three busy
measurements in [ADR-0025](adr/0025-parallel-test-suite.md), not by dropping work.
